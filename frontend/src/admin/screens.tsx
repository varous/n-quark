  ...
  return (
    <Card title="Sources">
      <Table rows={data?.sources ?? []} columns={[
        ...
        { key: "canonical_events", header: "Canonical events" },
        { key: "unique_cities", header: "Cities" },
        { key: "upcoming", header: "Upcoming" },
        { key: "ongoing", header: "Now" },
        { key: "past", header: "Past" },
        { key: "time_unknown", header: "Time unknown" },
        { key: "resolved_artists", header: "Artists" },
        { key: "resolved_venues", header: "Venues" },
        { key: "resolved_organizers", header: "Organizers" },
        { key: "organizer_mentions", header: "Organizer evidence" },
