...
_Last updated: 2026-08-09 (Phase 5A.3.1). Branch `main`. Repo: github.com/varous/n-quark._
...
observation **11** · entity **12** · **artist-intelligence 80** (+16 in 5A.3.1: candidate promotion
match/create/idempotent/bounded, ecosystem discovery, per-purpose search allocation + borrow + reserve +
near-reset, live event proximity + safe degrade) — all pass.
