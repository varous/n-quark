...
_Last updated: 2026-08-12 (Admin D.2). Branch `main`. Repo: github.com/varous/n-quark._
...
gateway **106** (+14 Admin D OIDC/boundary; +18 Admin D.1: cryptographic id_token verification (forged/
...
unauth 401 / viewer 200 / admin-disabled 404 / local-mode open) · signal **103** (+2 in 5A.3.3:
