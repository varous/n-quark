...
_Last updated: 2026-08-12 (Admin D.1). Branch `main`. Repo: github.com/varous/n-quark._
...
gateway **102** (+14 Admin D OIDC/boundary; +18 Admin D.1: cryptographic id_token verification (forged/
unknown-key/kid/alg=none/iss/aud/expiry/email/domain/hd-spoof/nonce), hard read-only enforcement,
session-cookie flags, expired-state) · signal **103** (+2 in 5A.3.3:
