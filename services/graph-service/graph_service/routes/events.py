...
def _feed_item(node, store: GraphStore) -> EventFeedItem:
    ...
    return EventFeedItem(
        ...
        starts_at=p.get("starts_at"), ends_at=p.get("ends_at"), event_date=p.get("event_date"),
        provider_lifecycle=p.get("provider_lifecycle"), price_min=price, currency=p.get("currency"),
